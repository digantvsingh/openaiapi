 ...
 */
@Schema(description = "Represents an individual `user` within an organization.")
...
public class User {
  ...
  public User object(ObjectEnum object) {
    this.object = object;
    return this;
  }
   ...
   * @return object
  **/
  @Schema(required = true, description = "The object type, which is always `organization.user`")
  ...
  **/
   ...
   * @return name
  **/
  @Schema(required = true, description = "The name of the user")
  ...
  **/
   ...
   * @return addedAt
  **/
  @Schema(required = true, description = "The Unix timestamp (in seconds) of when the user was added.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    User user = (User) o;
    return Objects.equals(this.object, user.object) &&
