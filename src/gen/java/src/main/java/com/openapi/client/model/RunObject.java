...
public class RunObject implements  AssistantStreamEvent {
  ...
  private AllOfRunObjectTruncationStrategy truncationStrategy = null;
  ...
  public RunObject toolResources(ModifyThreadRequestToolResources toolResources) {
  ...
  **/
  ...
  public RunObject reasoningEffort(ReasoningEffort reasoningEffort) {
  ...
  **/
  ...
  public RunObject truncationStrategy(AllOfRunObjectTruncationStrategy truncationStrategy) {
  ...
  **/
  @Schema(required = true, description = "")
  public AllOfRunObjectTruncationStrategy getTruncationStrategy() {
    return truncationStrategy;
  }

  public void setTruncationStrategy(AllOfRunObjectTruncationStrategy truncationStrategy) {
    this.truncationStrategy = truncationStrategy;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.toolResources, runObject.toolResources) &&
        Objects.equals(this.id, runObject.id) &&
        Objects.equals(this.reasoningEffort, runObject.reasoningEffort) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(toolResources, id, reasoningEffort, object, createdAt, threadId, assistantId, status, requiredAction, lastError, expiresAt, startedAt, cancelledAt, failedAt, completedAt, incompleteDetails, model, instructions, tools, metadata, usage, temperature, topP, maxPromptTokens, maxCompletionTokens, truncationStrategy, toolChoice, parallelToolCalls, responseFormat);
  }
