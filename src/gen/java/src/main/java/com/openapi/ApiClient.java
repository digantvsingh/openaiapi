...
import com.openapi.auth.Authentication;
...
public class ApiClient {
    ...
    public ApiClient(String openapiKey) {

        this.openAiKey = openapiKey;
        this.restTemplate = buildRestTemplate();
        init();
    ...
    protected void init() {
        ...
        //get api key from system property OPENAI_API_KEY
        apiKeyAuth.setApiKey(openAiKey);
    ...
    */
    ...
    protected RestTemplate buildRestTemplate() {
        ...
        // Configure the message converter to use the custom ObjectMapper
