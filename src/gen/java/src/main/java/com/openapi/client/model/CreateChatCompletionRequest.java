...
public class CreateChatCompletionRequest {
    ...
    public enum ModelEnum {
        ...
        CC_FINETUNESD("ft:gpt-3.5-turbo-0125:personal:career-counsellor:8zohIhku"),
     ...
     * @return logprobs
     **/
    @Schema(description = "Whether to return log probabilities of the output tokens or not. If true, returns the log probabilities of each output token returned in the `content` of `message`. This option is currently not available on the `gpt-4-vision-preview` model.")
     ...
     * @return tools
     **/
    @Schema(description = "A list of tools the model may call. Currently, only functions are supported as a tool. Use this to provide a list of functions the model may generate JSON inputs for. ")
