...
import com.openapi.client.model.AuditLogOrganizationUpdatedChangesRequestedSettings;
import io.swagger.v3.oas.annotations.media.Schema;
/**
 * The payload used to update the organization settings.
 */
@Schema(description = "The payload used to update the organization settings.")
...
public class AuditLogOrganizationUpdatedChangesRequested {
   ...
   * @return title
  **/
  @Schema(description = "The organization title.")
   ...
   * @return description
  **/
  @Schema(description = "The organization description.")
