...
import com.openapi.client.model.AuditLogActorApiKey;
import com.openapi.client.model.AuditLogActorSession;
import io.swagger.v3.oas.annotations.media.Schema;
/**
 * The actor who performed the audit logged action.
 */
@Schema(description = "The actor who performed the audit logged action.")
...
public class AuditLogActor {
   ...
   * @return type
  **/
  @Schema(description = "The type of actor. Is either `session` or `api_key`.")
